$(document).ready(function(){
    ...
    if(isMobile) {
    	...
    	// 	$('div.navbar-collapse.collapse ul.dropdown-menu').each(function(){
	    // 		$(this).addClass('sublist-open');
	    // 	});

	    // 	$('.navbar-collapse .navbar-nav li.dropdown a.dropdown-toggle').each(function(){
